...
class MewloController_ImageBrowser(mcontroller.MewloController):
    ...
    def controller_call(self, request):
        ...
        if (mode_requested == 'dirtree'):
            reth = self.respond_for_image_chooser(request, dir_requested, True, False, True, False, False)
        else:
            reth = self.respond_for_image_chooser(request, dir_requested, False, True, False, True, True)
    ...
    def respond_for_image_chooser(self, request, dir_requested, flag_showdirs, flag_showfiles, flag_recurse, flag_sayempty, flag_showimages):
