...
class MewloPackObject(object):
    """
    The PackObject class is the parent class for the actual 3rd party class that will be instantiated when a pack is LOADED+ENABLED.
    """
    ...
    def dumps(self, indent=0):
        ...
        outstr = " "*indent + "Base PackObject reporting in.\n"
        return outstr
