...
class MewloSettingsDb_Dynamic(MewloSettingsDb):
    ...
    An example of how you might use this, from old site construct:
        ...
        self.createappendcomp('packsettings', mdbsettings.MewloSettingsDb_Dynamic, dbmodelclassname=MewloSettings.DEF_DBCLASSNAME_PackSettings, dbmodeltablename=MewloSettings.DEF_DBTABLENAME_PackSettings)
        or
