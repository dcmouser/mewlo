...
The idea is that when this EGG is loaded into python, it should be discoverable via Mewlo.
...
Then when you run Mewlo, it should "disover" the installed addon package.
